...
import melva from '../../images/melva.png';
...
export default function AboutChurch() {
  ...
  return (
    <div className="center-page-about">
      <h1 className="color">The Mt. Olive Missionary Baptist Church History Project</h1>
      <img src={melva} alt="Mt. Olive Missionary Baptist Church" className="about-church-image" />
      <div className="left-justify-about">
        <p>This project honors the memory of Melva Viltz (1951-2025) and her two decades of dedication to the Mt. Olive Historical Ministry. The video history documentary, the church materials in this archive, and the successful completion of this project testify to her leadership.</p>
        <p>The Mt. Olive Missionary Baptist Church History project is a collaboration between the Mt. Olive Historical Ministry and the Flint Neighborhood History Project.</p>
      </div>
      <div className="left-justify-about">
        <h2>The Archive Project Team</h2>
        <p>The items in the Mt. Olive Missionary Baptist Church archive were gathered by members of the Historical Ministry between 2023 and 2025 under the leadership of Melva Viltz. Members of the archive working group included Betty Tippor, Wanda Harden, Alfreda Duncan, and Earnest and Nancy Pouncy. Items were also shared by Rev. Kenneth Gillard. The collection was preserved, catalogued, and digitized by Natalie Frary under the direction of Vickie Larsen and Pamela Hawkins of the Flint Neighborhood History Project. The digitization protocols and metadata structure were developed by Natalie Frary and Vickie Larsen in consultation with Anne Cong-Huyen, Joe Bauers, and Matt Caruthers, members of the Anti-Racist Digital Research Initiatives support team at the University of Michigan College of Literature Science and the Arts. Archive-quality digital files of the entire collection are held and owned by Mt. Olive Missionary Baptist Church.</p>      </div>
      <div className="left-justify-about">
        <h2>The Research</h2>
        <p>The research for the written history in these pages was conducted by Vickie Larsen of Morningside University and Natalie Frary of the University of Michigan-Flint. It is based upon historical narratives in the church archive and on primary sources including United States and Canadian census data; birth, marriage, military, and death records; City Directories; cemetery records; the Digital Archives of Ontario; Genesee County property records; the 1915 Sanborn insurance maps of Flint; and newspapers including The Flint Journal, The Lansing Journal, The Michigan Democrat, The Freeman, and the Bronze Reporter. Secondary sources used in developing this history include:</p>
        <ul>
          <li>Amherstburg Regular Missionary Baptist Association, A History of the Amherstburg Regular<br/>Missionary Baptist Association, Its Auxiliaries and Churches: Compiled from the Minutes and Historical Essays, 1940.</li>
      ...
      <div className="left-justify-about">
        ...
        <p>Digital video and audio editing was performed by Vickie Larsen. Digitized materials were converted into accessible formats to ensure compatibility with web viewing and were configured for a searchable database by student developers Simon Zychowski and Mackailee Longobricco of Morningside University. This website, its backend, and data are hosted on the google cloud platform. A github repository sends updates to the cloud deployed site.</p>
      </div>
      <div className="left-justify-about">
      ...
      <div className="left-justify-about">
        ...
        <p>Additions to the physical or digital Mt. Olive Missionary Baptist Church archives can be shared with members of the Historical Ministry, currently led by Betty Tipper. Please direct any revisions or corrections to existing materials or text to Betty Tipper or to Vickie Larsen at larsenv@morningside.edu</p>
      </div>
      <div className="left-justify-about">
        <h2>Permissions</h2>
